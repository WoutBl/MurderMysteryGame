...
export const Config: Configuration = {
  ...
  GENERATE_TOKEN_URL:
    process.env.REACT_APP_GENERATE_TOKEN_URL || 'https://generate-token-krid.onrender.com/',
  GENERATE_TOKEN_URL1:
    process.env.REACT_APP_GENERATE_TOKEN_URL1 || 'https://generate-token-krid.onrender.com/red',
  IMAGES_BODY_URI:
